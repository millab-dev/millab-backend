...
export const quizRoutes = new Elysia({ prefix: "/quizzes" })
    ...
    .post(
        ...
        },
        {
            ...
            detail: {
                ...
                description:
                    "Create a new quiz with questions and options. Each question must have exactly 4 options with only 1 correct answer.",
                tags: ["Quiz"],
            },
        }
    )
    ...
    .put(
        ...
        },
        {
            ...
            detail: {
                summary: "Update quiz",
                description:
                    "Update an existing quiz. Validation rules still apply for questions and options.",
                tags: ["Quiz"],
            },
        }
    )
    ...
    .get(
        ...
        async ({ params, set }) => {
            try {
                const quizzes = await quizService.getQuizzesByDifficulty(
                    params.difficulty
                );
                ...
                return {
                    ...
                    message:
                        error instanceof Error
                            ? error.message
                            : "Failed to get quizzes by difficulty",
                    data: null,
                };
            }
        },
    ...
    .post(
                ...
                for (const [key, value] of Object.entries(body.answers)) {
                    ...
                    if (isNaN(questionIndex)) {
                        ...
                        return {
                            success: false,
                            message:
                                "Answer keys must be valid question indices",
                            data: null,
                        };
                    }
        ...
        },
        {
            ...
            detail: {
                ...
                description:
                    "Submit answers for a quiz and get the calculated score. Answers should be provided as question index (0-based) to option index (0-3) mapping.",
                tags: ["Quiz"],
            },
        }
    )
    ...
    .get(
        ...
        },
        {
            ...
            detail: {
                ...
                description:
                    "Retrieve a quiz without correct answer information, suitable for quiz-taking interface",
                tags: ["Quiz"],
            },
        }
    );
